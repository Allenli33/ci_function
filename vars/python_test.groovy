        ...
        stages {
            ...
            stage('Deploy') {
                ...
                steps {
                        sshagent(['3855_vm']) {
                            sh """
                                ssh -o StrictHostKeyChecking=no azureuser@172.190.120.170' docker-compose -f /home/azureuser/acit3855/acit3855_lab7/deploy_jenkins/ pull && docker-compose -f /home/azureuser/acit3855/acit3855_lab7/deploy_jenkins/ up -d'
                            """
                        }
                    }
                }
